...
public class GuestRoomHelper implements ILiveRoomOption.onExceptionListener, ILiveRoomOption.onRoomDisconnectListener {
    private IGuestRoomView roomView;


    public GuestRoomHelper(IGuestRoomView view) {
        roomView = view;
    }
